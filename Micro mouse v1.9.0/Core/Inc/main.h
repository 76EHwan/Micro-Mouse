...
#define TOF_INT0_Pin GPIO_PIN_10
#define TOF_INT0_GPIO_Port GPIOC
#define TOF_INT1_Pin GPIO_PIN_11
#define TOF_INT1_GPIO_Port GPIOC
#define TOF_INT2_Pin GPIO_PIN_12
#define TOF_INT2_GPIO_Port GPIOC
#define TOF_INT3_Pin GPIO_PIN_2
#define TOF_INT3_GPIO_Port GPIOD
