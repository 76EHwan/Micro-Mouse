...
void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOC, LD2_Pin | XSHUT3_Pin | XSHUT2_Pin | MTR_INLx_Pin,
			GPIO_PIN_RESET);
	...
	HAL_GPIO_WritePin(GPIOA,
			MTR_R_DRVOFF_Pin | MTR_L_DRVOFF_Pin | MTR_nSLEEP_Pin | MTR_R_CS_Pin
					| MTR_L_CS_Pin | ENC_L_CS_Pin, GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, XSHUT1_Pin | XSHUT0_Pin | ENC_R_CS_Pin,
			GPIO_PIN_RESET);
	...
	GPIO_InitStruct.Pin = MTR_R_DRVOFF_Pin | MTR_L_DRVOFF_Pin | MTR_nSLEEP_Pin
			| MTR_R_CS_Pin | MTR_L_CS_Pin | ENC_L_CS_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
