...
#define LCD_Brightness_channel TIM_CHANNEL_3
...
void Set_Color(uint16_t font_color, uint16_t back_color) {
...
void LCD_Printf(int x, int y, const char *text, ...) {
	...
	LCD_ShowString(6 * x, 12 * y, ST7735Ctx.Width, 12, 12, (uint8_t*) (txt));
}
