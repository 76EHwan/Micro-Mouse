...
#define SOA_RA0_Pin GPIO_PIN_0
#define SOA_RA0_GPIO_Port GPIOA
#define SOB_RA1_Pin GPIO_PIN_1
#define SOB_RA1_GPIO_Port GPIOA
#define SOC_RA2_Pin GPIO_PIN_2
#define SOC_RA2_GPIO_Port GPIOA
#define SENSOR_IN3_Pin GPIO_PIN_3
#define SENSOR_IN3_GPIO_Port GPIOA
#define SENSOR_IN2_Pin GPIO_PIN_4
#define SENSOR_IN2_GPIO_Port GPIOA
#define SENSOR_IN1_Pin GPIO_PIN_5
#define SENSOR_IN1_GPIO_Port GPIOA
#define SENSOR_IN0_Pin GPIO_PIN_6
#define SENSOR_IN0_GPIO_Port GPIOA
