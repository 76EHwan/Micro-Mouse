...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_Pin|IR_IN_XSHUT0_Pin|ENC_R_CS_Pin|MTR_INLX_Pin
                          |MTR_L_CS_Pin|ENC_L_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, IR_IN_XSHUT3_Pin|IR_IN_XSHUT2_Pin|IR_IN_XSHUT1_Pin|MTR_L_DRVOFF_Pin
                          |MTR_nSLEEP_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MTR_R_DRVOFF_Pin|MTR_R_CS_Pin|LCD_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ToF_INT3_Pin ToF_INT2_Pin ToF_INT1_Pin ToF_INT0_Pin
                           MTR_L_nFAULT_Pin */
  GPIO_InitStruct.Pin = ToF_INT3_Pin|ToF_INT2_Pin|ToF_INT1_Pin|ToF_INT0_Pin
                          |MTR_L_nFAULT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
